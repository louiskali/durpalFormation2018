-- --------------------------------------------------------
-- Hôte:                         127.0.0.1
-- Version du serveur:           5.5.5-10.1.29-MariaDB - mariadb.org binary distribution
-- Serveur OS:                   Win32
...
-- Dumping structure for table drupal.actions
...
-- Dumping structure for table drupal.authmap
...
-- Dumping structure for table drupal.batch
...
-- Dumping structure for table drupal.block
...
-- Dumping structure for table drupal.blocked_ips
...
-- Dumping structure for table drupal.block_custom
...
-- Dumping structure for table drupal.block_node_type
...
-- Dumping structure for table drupal.block_role
...
-- Dumping structure for table drupal.cache
...
-- Dumping structure for table drupal.cache_admin_menu
...
-- Dumping structure for table drupal.cache_block
...
-- Dumping structure for table drupal.cache_bootstrap
...
-- Dumping structure for table drupal.cache_field
...
-- Dumping structure for table drupal.cache_filter
...
-- Dumping structure for table drupal.cache_form
...
-- Dumping structure for table drupal.cache_image
...
-- Dumping structure for table drupal.cache_libraries
...
-- Dumping structure for table drupal.cache_menu
...
-- Dumping structure for table drupal.cache_page
...
-- Dumping structure for table drupal.cache_path
...
-- Dumping structure for table drupal.cache_update
...
-- Dumping structure for table drupal.cache_views
...
-- Dumping structure for table drupal.cache_views_data
...
-- Dumping structure for table drupal.cck_field_settings
...
-- Dumping structure for table drupal.ckeditor_input_format
...
-- Dumping structure for table drupal.ckeditor_settings
...
-- Dumping structure for table drupal.comment
...
-- Dumping structure for table drupal.ctools_css_cache
...
-- Dumping structure for table drupal.ctools_object_cache
...
-- Dumping structure for table drupal.date_formats
...
-- Dumping structure for table drupal.date_format_locale
...
-- Dumping structure for table drupal.date_format_type
...
-- Dumping structure for table drupal.field_config
...
-- Dumping structure for table drupal.field_config_instance
...
-- Dumping structure for table drupal.field_data_body
...
-- Dumping structure for table drupal.field_data_comment_body
...
-- Dumping structure for table drupal.field_data_field_file_image_alt_text
...
-- Dumping structure for table drupal.field_data_field_file_image_title_text
...
-- Dumping structure for table drupal.field_data_field_image
...
-- Dumping structure for table drupal.field_data_field_image_du_slider
...
-- Dumping structure for table drupal.field_data_field_tags
...
-- Dumping structure for table drupal.field_revision_body
...
-- Dumping structure for table drupal.field_revision_comment_body
...
-- Dumping structure for table drupal.field_revision_field_file_image_alt_text
...
-- Dumping structure for table drupal.field_revision_field_file_image_title_text
...
-- Dumping structure for table drupal.field_revision_field_image
...
-- Dumping structure for table drupal.field_revision_field_image_du_slider
...
-- Dumping structure for table drupal.field_revision_field_tags
...
-- Dumping structure for table drupal.file_display
...
-- Dumping structure for table drupal.file_managed
...
-- Dumping structure for table drupal.file_metadata
...
-- Dumping structure for table drupal.file_type
...
-- Dumping structure for table drupal.file_usage
...
-- Dumping structure for table drupal.filter
...
-- Dumping structure for table drupal.filter_format
...
-- Dumping structure for table drupal.flexslider_optionset
...
-- Dumping structure for table drupal.flood
...
-- Dumping structure for table drupal.history
...
-- Dumping structure for table drupal.image_effects
...
-- Dumping structure for table drupal.image_styles
...
-- Dumping structure for table drupal.menu_custom
...
-- Dumping structure for table drupal.menu_links
...
-- Dumping structure for table drupal.menu_router
...
-- Dumping structure for table drupal.node
...
-- Dumping structure for table drupal.node_access
...
-- Dumping structure for table drupal.node_comment_statistics
...
-- Dumping structure for table drupal.node_revision
...
-- Dumping structure for table drupal.node_type
...
-- Dumping structure for table drupal.queue
...
-- Dumping structure for table drupal.rdf_mapping
...
-- Dumping structure for table drupal.registry
...
-- Dumping structure for table drupal.registry_file
...
-- Dumping structure for table drupal.role
...
-- Dumping structure for table drupal.role_permission
...
-- Dumping structure for table drupal.search_dataset
...
-- Dumping structure for table drupal.search_index
...
-- Dumping structure for table drupal.search_node_links
...
-- Dumping structure for table drupal.search_total
...
-- Dumping structure for table drupal.semaphore
...
-- Dumping structure for table drupal.sequences
...
-- Dumping structure for table drupal.sessions
...
-- Dumping structure for table drupal.shortcut_set
...
-- Dumping structure for table drupal.shortcut_set_users
...
-- Dumping structure for table drupal.system
...
-- Dumping structure for table drupal.taxonomy_index
...
-- Dumping structure for table drupal.taxonomy_term_data
...
-- Dumping structure for table drupal.taxonomy_term_hierarchy
...
-- Dumping structure for table drupal.taxonomy_vocabulary
...
-- Dumping structure for table drupal.url_alias
...
-- Dumping structure for table drupal.users
...
-- Dumping structure for table drupal.users_roles
...
-- Dumping structure for table drupal.variable
...
-- Dumping structure for table drupal.views_display
...
-- Dumping structure for table drupal.views_view
...
-- Dumping structure for table drupal.watchdog
